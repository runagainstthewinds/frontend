    ...
    <div className="fixed inset-0 bg-white/20 backdrop-blur-sm flex justify-center items-center z-50">
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6 m-4">
          ...
          <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded mb-4">
            {error.includes("Username already exists") ? (
              <div className="flex flex-col">
                ...
                <span className="text-sm">Please choose a different username</span>
              </div>
            ) : (
              error
            )}
        ...
        {isLoginView ? (
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              <label htmlFor="register-username" className="block text-gray-700 font-medium mb-2">
                Username
              </label>
              <input
                type="text"
            ...
            <div className="mb-4">
              ...
              <div className="mt-2 space-y-1 text-sm">
                ...
                <div className="flex items-center">
                  ...
                  <span className={passwordValidation.length ? 'text-teal-700' : 'text-gray-500'}>
                    Between 8 and 32 characters
                  </span>
                </div>
                <div className="flex items-center">
                  <div className={`w-4 h-4 mr-2 rounded-full ${
                    passwordValidation.hasUppercase ? 'bg-teal-600' : 'bg-gray-300'
                  }`}></div>
                  <span className={passwordValidation.hasUppercase ? 'text-teal-700' : 'text-gray-500'}>
                    At least one uppercase letter
                  </span>
                </div>
                <div className="flex items-center">
                  <div className={`w-4 h-4 mr-2 rounded-full ${
                    passwordValidation.hasNumber ? 'bg-teal-600' : 'bg-gray-300'
                  }`}></div>
                  <span className={passwordValidation.hasNumber ? 'text-teal-700' : 'text-gray-500'}>
                    At least one number
                  </span>
                </div>
              </div>
            ...
            <div className="mb-4">
              <label htmlFor="register-confirm-password" className="block text-gray-700 font-medium mb-2">
                Confirm Password
              </label>
              <input
                type="password"
