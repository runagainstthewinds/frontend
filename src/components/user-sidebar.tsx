        ...
        <SidebarHeader className="pb-0">
          <div className="flex flex-col items-center space-y-4 pt-4">
            <Avatar className="h-24 w-24 ring-2 ring-teal-600 ring-offset-4 ring-offset-teal-50/10 shadow-lg">
              ...
              <AvatarFallback className="bg-teal-600 text-white text-xl font-medium">JD</AvatarFallback>
            </Avatar>
            <div className="text-center">
              <h2 className="text-xl font-bold">John Doe</h2>
              <a href="/achievements" className="text-teal-600 text-sm font-medium hover:underline">
                View Achievements
              </a>
            </div>
          </div>
            ...
            <SidebarGroupContent>
              <div className="space-y-3">
                <div className="flex items-center justify-between rounded-lg bg-background p-3 shadow-sm border">
                  ...
                  <Badge className="bg-teal-100 text-teal-800 hover:bg-teal-100">Connected</Badge>
                </div>
                <div className="flex items-center justify-between rounded-lg bg-background p-3 shadow-sm border">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-sm font-medium text-muted-foreground">Strava</span>
                  </div>
