...
function LandingPage() {
    ...
    <div className="relative min-h-screen w-full">
      ...
      <div className="absolute inset-0 w-full h-screen z-0">
        <div className="relative h-full w-full clip-diagonal">
          <img src="/running-background.png" alt="Running background" className="object-cover w-full h-full" />
      ...
      <div className="relative z-10 flex justify-center items-center flex-col h-screen w-full gap-y-4 px-4 sm:px-6 md:px-8 text-center">
        ...
        <h2 className="text-xl sm:text-2xl text-teal-50 max-w-3xl">
          Whether you are planning for your upcoming marathon or trying to get back in shape, we have{" "}
          <span className="text-white font-semibold">personalized</span> plans that will make you improve
        </h2>
      </div>
      <div className="py-10">
          ...
          <div className="container max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="md:w-1/2 space-y-4">
                ...
                <h2 className="text-3xl font-bold text-gray-900">Track Your Running Shoes</h2>
                <p className="text-gray-600">
                  Never wear out your shoes again. Our shoe tracking feature monitors the mileage on each pair and sends
                  you timely reminders when it's time for a replacement.
                </p>
          ...
          <div className="container max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row-reverse items-center gap-8">
              ...
              <div className="md:w-1/2 space-y-4">
                ...
                <h2 className="text-3xl font-bold text-gray-900">Connect With Strava</h2>
                <p className="text-gray-600">
                  Seamlessly integrate with your Strava account to import all your activities and stats. No manual entry
                  required - your runs automatically sync to our platform.
                </p>
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <svg
          ...
          <div className="container max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="md:w-1/2 space-y-4">
                ...
                <p className="text-gray-600">
                  Keep your training schedule organized by syncing your runs directly with Google Calendar. Plan future workouts
      ...
      <section className="bg-teal-800 py-16 w-full">
        <div className="container max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-white mb-4">Ready to start your running journey?</h2>
          <p className="text-teal-100 mb-8">Join other runners who have achieved their goals with our platform</p>
        ...
        <div className="container max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              <span className="text-white text-xl font-bold">Run Against The Wind</span>
              <p className="mt-2 text-sm">Helping runners achieve their goals since 2025</p>
            </div>
 ...
 11.616 0 006.29 1.84"
          ...
          <div className="mt-8 border-t border-gray-800 pt-6 flex flex-col md:flex-row justify-between">
            <p className="text-sm">© 2025 Run Against The Wind. All rights reserved.</p>
